...
void SSD1963_Init(void) {
	...
	SSD1963_WriteData(SSD1963_PDI_8BIT); //SSD1963_PDI_16BIT565, SSD1963_PDI_8BIT
...
void SSD1963_WriteColor(u32 color) {
	SSD1963_WriteData((color >> 16) & 0xFF); // R
	SSD1963_WriteData((color >> 8) & 0xFF); // G
	SSD1963_WriteData((color) & 0xFF); // B
}
//=============================================================================
