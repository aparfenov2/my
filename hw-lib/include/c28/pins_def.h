...
typedef union {
	...
	struct {          // bits   description
	   ...
	   u16 GPIO13:1;           // 13     GPIO13
	   u16 GPIO14:1;           // 14     GPIO14
	   u16 GPIO15:1;           // 15     GPIO15 CS
	   u16 GPIO16:1;           // 16     GPIO16
	   u16 GPIO17:1;           // 17     GPIO17 RST
	   u16 GPIO18:1;           // 18     GPIO18 DISP
	   u16 GPIO19:1;           // 19     GPIO19
	   u16 CS:1;           // 20     GPIO20
	   u16 DC:1;           // 21     GPIO21
	   u16 WR:1;           // 22     GPIO22 WR
	   u16 RD:1;           // 23     GPIO23
	   u16 GPIO24:1;           // 24     GPIO24
	   u16 GPIO25:1;           // 25     GPIO25
	   u16 BL_E:1;           // 26     GPIO26
	   u16 GPIO27:1;           // 27     GPIO27
	   u16 GPIO28:1;           // 28     GPIO28 RD
	   u16 GPIO29:1;           // 29     GPIO29
	   u16 GPIO30:1;           // 30     GPIO30, RS DC
	   u16 GPIO31:1;           // 31     GPIO31
	} bits;
} port_a_t;
